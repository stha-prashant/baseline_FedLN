...
def estimate_noise_with_pretrained_knn(labels, features, num_classes, weights='uniform', num_neighbors=10, noise_theshold=0.15, verbose=True):
	# Initialize
	...
	print(f"--------------Estimated noise level {100*est_noise_lvl:.02f}%")
